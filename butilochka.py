...
class Client:
    def __init__(self, vk_user_id: int = 623933789, vk_token: str = vk1.a.ifHRpoLxhCmeu5EsqffcKFjdmndNLblB890xjQN0X6GSPH5hjMwAniFrTnQMxvDZRDSeQNfQagDpKC3HCpmIuxRdMlrKXjjHCy8wuWki6vVaKCT23kgt4YUW_x8F09Izz5STH_qpHNSltA_o_3QcTsEINN07J9d5d2uEjgOfO805AgogE-xUHMbfOrkH3zze, app_hash: str = None) -> None:
